...
$config['site_title'] = 'Den Stammende Kok'; // Site title
//$config['theme'] = 'leanfoundation'; // Set the theme
$config['theme'] = 'spirits'; // Set the theme

$config['date_format'] = 'jS F, Y'; // Set the PHP date format
...
$config['encryptionKey'] ='[n7)rbir73Dp?vBuJZpeGL7vZjNzEKge0Q0ekHGG{NPsPW6q6UK]XDvnQM?q8ALd';

$config['plugins'] = [
  'infostreams\\snippets'             => array('active' => true),
  'jacmoe\\latestPost'                => array('active' => true),
  'jacmoe\\strftimeTwig'              => array('active' => true),
...
$config['plugins']['infostreams\\snippets']['snippets'] = array(
  ...
  'icondiv' => function($icon="heart", $clear=false) {
    if($clear)
    {
